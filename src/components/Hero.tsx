...
const Hero = () => {
  return (
    <div className="relative bg-gradient-to-b from-[#1A1F2C] to-[#065d88] text-white">
        ...
        <div className="flex flex-wrap justify-center mt-8 gap-4">
          <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
            <div className="w-6 h-6 rounded-full bg-payfare-300 flex items-center justify-center mr-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#1A1F2C]">
